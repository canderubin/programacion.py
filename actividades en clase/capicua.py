'''Desarrollar un programa que solicite al usuario el ingreso de un número entero de tres cifras y determine si dicho número 
es capicúa (es decir, que se lee igual de izquierda a derecha que de derecha a izquierda).
...
if numero == "":
    ...
    if int(numero) < 100 or int(numero) > 999:
